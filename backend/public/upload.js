window.addEventListener("DOMContentLoaded", () => {
    ...
    async function fetchAllUploads(keepViewState = false) {
        try {
            ...
            const productsToShow = showingAll ? allProducts : allProducts.slice(0, 6);
            renderProducts(productsToShow, !showingAll);
        } catch (err) {
    ...
    async function deleteProduct(id) {
        ...
        try {
            ...
            if (data.success) {
                ...
                setTimeout(() => fetchAllUploads(true), 1000);
            } else {
        ...
        uploadForm.addEventListener("submit", async (e) => {
            ...
            try {
                ...
                if (res.ok && data.success) {
                    ...
                    // Keep the current view state (showing all or first 6)
                    setTimeout(() => fetchAllUploads(true), 800);
                } else {
